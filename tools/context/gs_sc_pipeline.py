...
from tools.context.context_builder import ContextPacket, ContextBuilder, ContextConfig
from core.cache import SafeFullCache   # 复用缓存层
from tools.context.context_monitor import ContextMonitor   # 上下文构建监控日志
...
if __name__ == "__main__":
    ...
    # 记忆系统
    try:
        from tools.memory.memory_tool import MemoryManager, MemoryEntry
