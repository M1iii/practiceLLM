...
from core.llm import practiceLLM, LLMClient    # LLM 客户端 + 统一接口协议
from agents.framework.agent_framework import Message    # 统一消息模型（agent_framework.py）
from tools.framework.tool_system import Tool, ToolRegistry    # 新框架工具基类 + 统一注册表
...
if __name__ == "__main__":
    from tools.framework.tool_system import CalculatorTool, TimeTool
